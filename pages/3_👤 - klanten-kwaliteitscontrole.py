...
with col2:
    ...
    gel_aant_penny_wafels = st.number_input("Aantal penny_wafels", step=1)
...
with col3:
    ...
    kwal_penny_wafels = st.number_input("Goede penny_wafels", step=1, value=gel_aant_penny_wafels)
